...
recyclable_templates = [
    "a photo of a {} item.",
    "a close-up photo of a {}.",
    "a photo of a {} waste object.",
    "a photo showing {} trash.",
    "a photo of a {} for recycling.",
    "a photo of discarded {}.",
    "a photo showing a {} among household waste.",
    "a clean {} ready to be recycled.",
    "an image of {} garbage.",
    "a real-world photo of a {} item."
]
...
TEMPLATES_DIC = {
    ...
    'recyclable': recyclable_templates,
