...
def create_labels_recyclable():
    print('\nCreating labels for recyclable')

    file = f'{ROOT}/recyclable/split_zhou_Recyclable.json'
    with open(file, 'r') as f:
        data = json.load(f)
    train_split = data['train']
    val_split = data['val']
    ...
    # create the train.txt, val.txt, test.txt
    prefix=f''
    format_txt(train_split, prefix, 'data/recyclable/train.txt')
    format_txt(val_split, prefix, 'data/recyclable/val.txt')
    format_txt(test_split, prefix, 'data/recyclable/test.txt')

def create_labels_garbage():
    print('\nCreating labels for garbage')

    file = f'{ROOT}/garbage/split_zhou_garbage.json'
    with open(file, 'r') as f:
        data = json.load(f)
    train_split = data['train']
    val_split = data['val']
    ...
    # create the train.txt, val.txt, test.txt
    prefix=f''
    format_txt(train_split, prefix, 'data/garbage/train.txt')
    format_txt(val_split, prefix, 'data/garbage/val.txt')
    format_txt(test_split, prefix, 'data/garbage/test.txt')
...
if __name__ == '__main__':
    ...
    # create_labels_recyclable()
    create_labels_garbage()
